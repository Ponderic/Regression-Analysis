...
mydatawv3$oop <- rowSums(mydatawv3[, c("w3_h_nfmedaidspn", "w3_h_nfdocspn","w3_h_nfhspspn","w3_h_nfmedspn","w3_h_nftradspn","w3_h_nfhomspn")],na.rm=T)
...
summary(mydatawv3$oop)
describe(mydatawv3$oop)


mydatawv3$sine_oop<-asinh(mydatawv3$oop) #clean OOP and use sine_oop as Dependent var
...
#colnames(mydatawv4) #to find all column names
#mydatawv4_new<- select (mydatawv4, w4_h_nfmedaidspn, w4_h_nfdocspn,w4_h_nfhspspn,w4_h_nfmedspn,w4_h_nftradspn,w4_h_nfhomspn)
mydatawv4$oop <- rowSums(mydatawv4[, c("w4_h_nfmedaidspn", "w4_h_nfdocspn","w4_h_nfhspspn","w4_h_nfmedspn","w4_h_nftradspn","w4_h_nfhomspn")],na.rm=T)
#create a new column variable for OOP   
#mydatawv4$oop<-((mydatawv4$oop)*12) #for the year

#descriptives

summary(mydatawv4$oop)
describe(mydatawv4$oop)



mydatawv4$sine_oop<-asinh(mydatawv4$oop) #clean OOP and use sine_oop as Dependent var
...
#colnames(mydatawv4) #to find all column names
#mydatawv4_new<- select (mydatawv4, w4_h_nfmedaidspn, w4_h_nfdocspn,w4_h_nfhspspn,w4_h_nfmedspn,w4_h_nftradspn,w4_h_nfhomspn)
mydatawv5$oop <- rowSums(mydatawv5[, c("w5_h_nfmedaidspn", "w5_h_nfdocspn","w5_h_nfhspspn","w5_h_nfmedspn","w5_h_nftradspn","w5_h_nfhomspn")],na.rm=T)
#create a new column variable for OOP   
#mydatawv4$oop<-((mydatawv4$oop)*12) #for the year
...
summary(mydatawv5$oop)
describe(mydatawv5$oop)


mydatawv5$sine_oop<-asinh(mydatawv5$oop) #clean OOP and use sine_oop as Dependent var
...
#main ind var
#insurance coverage 
mydatawv3 <- mydatawv3 %>% mutate(coverage = ifelse(w3_h_nfmedaid<2, 1, 0))
table(mydatawv3$coverage)
...
mydatawv3 <- mydatawv3 %>% mutate(age = ifelse(w3_a_dob_y>=1942, 1, 0))
count(mydatawv3, age)
table(mydatawv3$age)
#gender
count(mydatawv3, w3_a_gen)
table(mydatawv3$w3_a_gen)
mydatawv3$male<-ifelse(mydatawv3$w3_a_gen<2,1,0)
#race
count(mydatawv3, w3_a_popgrp)
table(mydatawv3$w3_a_popgrp)
mydatawv3$african<-ifelse(mydatawv3$w3_a_popgrp<2,1,0)
#ever married or never married
count(mydatawv3, w3_a_marstt)
table(mydatawv3$w3_a_marstt)
mydatawv3$ever_married<-ifelse(mydatawv3$w3_a_marstt<5,1,0)
#province
count(mydatawv3, w3_a_brnprov)
table(mydatawv3$w3_a_brnprov)
mydatawv3$west_cape<-ifelse(mydatawv3$w3_a_brnprov==1,1,0)
mydatawv3$east_cape<-ifelse(mydatawv3$w3_a_brnprov==2,1,0)
mydatawv3$north_cape<-ifelse(mydatawv3$w3_a_brnprov==3,1,0)
mydatawv3$free_state<-ifelse(mydatawv3$w3_a_brnprov==4,1,0)
mydatawv3$kwazulu<-ifelse(mydatawv3$w3_a_brnprov==5,1,0)
mydatawv3$north_west<-ifelse(mydatawv3$w3_a_brnprov==6,1,0)
mydatawv3$gauteng<-ifelse(mydatawv3$w3_a_brnprov==7,1,0)
mydatawv3$mpumalanga<-ifelse(mydatawv3$w3_a_brnprov==8,1,0)
mydatawv3$limpopo<-ifelse(mydatawv3$w3_a_brnprov==9,1,0)
 
#number of children living with respondent #IV
count(mydatawv3, w3_a_bhlive_n)
table(mydatawv3$w3_a_bhlive_n)
mydatawv3$child_livingwith<-as.numeric(mydatawv3$w3_a_bhlive_n)
mydatawv3$child_livingwith <- replace(mydatawv3$child_livingwith, mydatawv3$child_livingwith < 0, 0)
#educational level
count(mydatawv3, w3_a_edterlev)
table(mydatawv3$w3_a_edterlev)
mydatawv3$BA_above<-ifelse(mydatawv3$w3_a_edterlev>=20,1,0)
table(mydatawv3$BA_above)
#employed
count(mydatawv3, w3_a_em1)
table(mydatawv3$w3_a_em1)
mydatawv3$employed<-ifelse(mydatawv3$w3_a_em1<2,1,0)
#care dependency grant
mydatawv3 <- mydatawv3 %>% mutate(care_grant = ifelse(w3_a_inccare<2, 1, 0))
table(mydatawv3$care_grant)
#ILLness
#disabled
mydatawv3 <- mydatawv3 %>% mutate(disabled = ifelse(w3_a_hlser<2, 1, 0))
table(mydatawv3$disabled)

#diabetes
mydatawv3 <- mydatawv3 %>% mutate(diabetes = ifelse(w3_a_hldia<2, 1, 0))

#high blood pressure or hypertension
mydatawv3 <- mydatawv3 %>% mutate(hypertension = ifelse(w3_a_hlbp <2, 1, 0))


#income household
summary(mydatawv3$w3_h_tinc)
describe(mydatawv3$w3_h_tinc)

mydatawv3$inc<-mydatawv3$w3_h_tinc #*12

###############################################################
summary(mydatawv3$inc)
describe(mydatawv3$inc)

#################################################################
mydatawv3$IHSinc<-asinh(mydatawv3$inc)
mydatawv3$IHSinc<-as.numeric(mydatawv3$IHSinc) #inverse hyperbolic sine transformation
mydatawv3<-mydatawv3[!is.na(mydatawv3$IHSinc),]

#household size
mydatawv3$equi_size<-mydatawv3$w3_h_dwlrms
 
#IV #self-employed
mydatawv3 <- mydatawv3 %>% mutate(self_employed = ifelse(w3_a_ems<2, 1, 0))
table(mydatawv3$self_employed)
...
summary(mydatawv4$non_food_exp)
describe(mydatawv4$non_food_exp)

summary(mydatawv4$total_exp)
describe(mydatawv4$total_exp)


summary(mydatawv4$food_exp)
describe(mydatawv4$food_exp)
...
#main ind var
#insurance coverage 
mydatawv4 <- mydatawv4 %>% mutate(coverage = ifelse(w4_h_nfmedaid<2, 1, 0))
table(mydatawv4$coverage)
...
#age >=70 years...2014-70
mydatawv4 <- mydatawv4 %>% mutate(age = ifelse(w4_a_dob_y>=1944, 1, 0))
count(mydatawv4, age)
table(mydatawv4$age)
#gender
count(mydatawv4, w4_a_gen)
table(mydatawv4$w4_a_gen)
mydatawv4$male<-ifelse(mydatawv4$w4_a_gen<2,1,0)
#race
count(mydatawv4, w4_a_popgrp)
table(mydatawv4$w4_a_popgrp)
mydatawv4$african<-ifelse(mydatawv4$w4_a_popgrp<2,1,0)
#ever married or never married
count(mydatawv4, w4_a_evmar)
table(mydatawv4$w4_a_evmar)
mydatawv4$ever_married<-ifelse(mydatawv4$w4_a_evmar==1,1,0)
table(mydatawv4$ever_married)
#province
count(mydatawv4, w4_a_brnprov)
table(mydatawv4$w4_a_brnprov)
mydatawv4$west_cape<-ifelse(mydatawv4$w4_a_brnprov==1,1,0)
mydatawv4$east_cape<-ifelse(mydatawv4$w4_a_brnprov==2,1,0)
mydatawv4$north_cape<-ifelse(mydatawv4$w4_a_brnprov==3,1,0)
mydatawv4$free_state<-ifelse(mydatawv4$w4_a_brnprov==4,1,0)
mydatawv4$kwazulu<-ifelse(mydatawv4$w4_a_brnprov==5,1,0)
mydatawv4$north_west<-ifelse(mydatawv4$w4_a_brnprov==6,1,0)
mydatawv4$gauteng<-ifelse(mydatawv4$w4_a_brnprov==7,1,0)
mydatawv4$mpumalanga<-ifelse(mydatawv4$w4_a_brnprov==8,1,0)
mydatawv4$limpopo<-ifelse(mydatawv4$w4_a_brnprov==9,1,0)
 
#number of children living with respondent #IV
count(mydatawv4, w4_a_bhlive_n)
table(mydatawv4$w4_a_bhlive_n)
mydatawv4$child_livingwith<-as.numeric(mydatawv4$w4_a_bhlive_n)
mydatawv4$child_livingwith <- replace(mydatawv4$child_livingwith, mydatawv4$child_livingwith < 0, 0)
#educational level
count(mydatawv4, w4_a_edterlev)
table(mydatawv4$w4_a_edterlev)
mydatawv4$BA_above<-ifelse(mydatawv4$w4_a_edterlev>=20,1,0)
table(mydatawv4$BA_above)
#employed
count(mydatawv4, w4_a_em1)
table(mydatawv4$w4_a_em1)
mydatawv4$employed<-ifelse(mydatawv4$w4_a_em1<2,1,0)
#care dependency grant
mydatawv4 <- mydatawv4 %>% mutate(care_grant = ifelse(w4_a_inccare<2, 1, 0))
table(mydatawv4$care_grant)
#ILLness
#disabled
mydatawv4 <- mydatawv4 %>% mutate(disabled = ifelse(w4_a_hlser<2, 1, 0))
table(mydatawv4$disabled)

#diabetes
mydatawv4 <- mydatawv4 %>% mutate(diabetes = ifelse(w4_a_hldia<2, 1, 0))

#high blood pressure or hypertension
mydatawv4 <- mydatawv4 %>% mutate(hypertension = ifelse(w4_a_hlbp <2, 1, 0))

#income household
summary(mydatawv4$w4_h_tinc)
describe(mydatawv4$w4_h_tinc)
mydatawv4$inc<-mydatawv4$w4_h_tinc #*12
...
mydatawv4$IHSinc<-asinh(mydatawv4$inc)
mydatawv4$IHSinc<-as.numeric(mydatawv4$IHSinc) #inverse hyperbolic sine transformation
mydatawv4<-mydatawv4[!is.na(mydatawv4$IHSinc),]

#household size
mydatawv4$equi_size<-mydatawv4$w4_h_dwlrms
 
#IV #self-employed
mydatawv4 <- mydatawv4 %>% mutate(self_employed = ifelse(w4_a_ems<2, 1, 0))
table(mydatawv4$self_employed)
...
summary(mydatawv5$non_food_exp)
describe(mydatawv5$non_food_exp)

summary(mydatawv5$total_exp)
describe(mydatawv5$total_exp)


summary(mydatawv5$food_exp)
describe(mydatawv5$food_exp)
...
#insurance premium 
mydatawv5 <- mydatawv5 %>% mutate(coverage = ifelse(w5_h_nfmedaid<2, 1, 0))
table(mydatawv5$coverage)
...
mydatawv5 <- mydatawv5 %>% mutate(age = ifelse(w5_a_dob_y>=1946, 1, 0))
count(mydatawv5, age)
table(mydatawv5$age)
#gender
count(mydatawv5, w5_a_gen)
table(mydatawv5$w5_a_gen)
mydatawv5$male<-ifelse(mydatawv5$w5_a_gen<2,1,0)
#race
count(mydatawv5, w5_a_popgrp)
table(mydatawv5$w5_a_popgrp)
mydatawv5$african<-ifelse(mydatawv5$w5_a_popgrp<2,1,0)
#ever married or never married
count(mydatawv5, w5_a_evmar)
table(mydatawv5$w5_a_evmar)
mydatawv5$ever_married<-ifelse(mydatawv5$w5_a_evmar<2,1,0)
#province
count(mydatawv5, w5_a_brnprov)
table(mydatawv5$w5_a_brnprov)
mydatawv5$west_cape<-ifelse(mydatawv5$w5_a_brnprov==1,1,0)
mydatawv5$east_cape<-ifelse(mydatawv5$w5_a_brnprov==2,1,0)
mydatawv5$north_cape<-ifelse(mydatawv5$w5_a_brnprov==3,1,0)
mydatawv5$free_state<-ifelse(mydatawv5$w5_a_brnprov==4,1,0)
mydatawv5$kwazulu<-ifelse(mydatawv5$w5_a_brnprov==5,1,0)
mydatawv5$north_west<-ifelse(mydatawv5$w5_a_brnprov==6,1,0)
mydatawv5$gauteng<-ifelse(mydatawv5$w5_a_brnprov==7,1,0)
mydatawv5$mpumalanga<-ifelse(mydatawv5$w5_a_brnprov==8,1,0)
mydatawv5$limpopo<-ifelse(mydatawv5$w5_a_brnprov==9,1,0)
 
#number of children living with respondent
count(mydatawv5, w5_a_bhlive_n)
table(mydatawv5$w5_a_bhlive_n)
mydatawv5$child_livingwith<-as.numeric(mydatawv5$w5_a_bhlive_n)
mydatawv5$child_livingwith <- replace(mydatawv5$child_livingwith, mydatawv5$child_livingwith < 0, 0)
#educational level
count(mydatawv5, w5_a_edterlev)
table(mydatawv5$w5_a_edterlev)
mydatawv5$BA_above<-ifelse(mydatawv5$w5_a_edterlev>=20,1,0)
table(mydatawv5$BA_above)
#employed
count(mydatawv5, w5_a_em1)
table(mydatawv5$w5_a_em1)
mydatawv5$employed<-ifelse(mydatawv5$w5_a_em1<2,1,0)
#care dependency grant
mydatawv5 <- mydatawv5 %>% mutate(care_grant = ifelse(w5_a_inccare<2, 1, 0))
table(mydatawv5$care_grant)
#ILLness
#disabled
mydatawv5 <- mydatawv5 %>% mutate(disabled = ifelse(w5_a_hlser<2, 1, 0))
table(mydatawv5$disabled)

#diabetes
mydatawv5 <- mydatawv5 %>% mutate(diabetes = ifelse(w5_a_hldia<2, 1, 0))

#high blood pressure or hypertension
mydatawv5 <- mydatawv5 %>% mutate(hypertension = ifelse(w5_a_hlbp <2, 1, 0))

#household income
summary(mydatawv5$w5_h_tinc)
describe(mydatawv5$w5_h_tinc)

mydatawv5$inc<-mydatawv5$w5_h_tinc #*12
...
mydatawv5$IHSinc<-asinh(mydatawv5$inc)
mydatawv5$IHSinc<-as.numeric(mydatawv5$IHSinc) #inverse hyperbolic sine transformation
mydatawv5<-mydatawv5[!is.na(mydatawv5$IHSinc),]

#household size
mydatawv5$equi_size<-mydatawv5$w5_h_dwlrms


#IV
#IV #self-employed
mydatawv5 <- mydatawv5 %>% mutate(self_employed = ifelse(w5_a_ems<2, 1, 0))
table(mydatawv5$self_employed)
```
